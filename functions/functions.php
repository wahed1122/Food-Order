...
function add_cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        if(mysqli_num_rows($run_check)>0){
            ...
            echo "<script>window.open('details?pro_id=$p_id','_self')</script>";
...
function getPro(){
    ...
    $get_products = "select * from products where cat_id=12 order by 1 DESC LIMIT 0,20";
    
    $run_products = mysqli_query($db,$get_products);
    
    while($row_products=mysqli_fetch_array($run_products)){
        
        $pro_id = get_safe_value($db,$row_products['product_id']);
        
        $pro_title = get_safe_value($db,$row_products['product_title']);
        
        $pro_price = get_safe_value($db,$row_products['product_price']);

        $pro_sale_price = get_safe_value($db,$row_products['product_sale']);
        
        $pro_img1 = get_safe_value($db,$row_products['product_img1']);
        
        $pro_label = get_safe_value($db,$row_products['product_label']);
        
        $manufacturer_id = get_safe_value($db,$row_products['manufacturer_id']);
...
function getPro1(){
    ...
    $get_products = "select * from products where cat_id=13 order by 1 DESC LIMIT 0,20";
...
function getPro2(){
    ...
    $get_products = "select * from products where cat_id=15 order by 1 DESC LIMIT 0,20";
...
function getPro3(){
    ...
    $get_products = "select * from products where cat_id=14 order by 1 DESC LIMIT 0,20";
...
function getPro4(){
    ...
    $get_products = "select * from products where cat_id=16 order by 1 DESC LIMIT 0,20";
...
function getPro5(){
    ...
    $get_products = "select * from products where cat_id=17 order by 1 DESC LIMIT 0,20";
...
function getPro6(){
    ...
    $get_products = "select * from products where cat_id=18 order by 1 DESC LIMIT 0,20";
...
function getPaginator(){
    ...
    echo "<li> <a href='fast-food.php?page=1";
    if(!empty($aPath)){
    ...
    for($i=1; $i<=$total_pages; $i++){
        ...
        echo "<li> <a href='fast-food.php?page=".$i.(!empty($aPath)?'&'.$aPath:'')."'>".$i."</a></li>";

    };

    echo "<li> <a href='fast-food.php?page=$total_pages";
