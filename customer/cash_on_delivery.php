       ...
       <div class="container col-md-12"><!-- container Begin -->
           ...
           <div class="navbar-header col-md-3"><!-- navbar-header Begin -->
               ...
               <a href="../index" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/KHB_Logo.png" alt="Krishi Hat Bazar Logo" class="hidden-xs"style="height:80px;width:211px">
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   if(isset($_GET['c_id'])){
					...
					$customer_id = get_safe_value($con,$_GET['c_id']);
                    ...
                    if(isset($_POST['confirm_payment'])){
						...
						while($row_cart = mysqli_fetch_array($run_cart ) ){
							...
							while($row_products = mysqli_fetch_array($run_products)){
								...
								$insert_customer_order = "INSERT INTO `customer_orders`(customer_id,`due_amount`,payment_name,`qty`,`product_id`, `order_date`,`details_address`,`post_office`,`order_status`) VALUES ('$customer_id','$sub_total','$payment_mode','$pro_qty','$pro_id',NOW(),'$details_address','$post_office','$status')";
