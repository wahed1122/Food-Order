               ...
               <div class="padding-nav"><!-- padding-nav Begin -->
                   ...
                   <ul class="nav navbar-nav left"><!-- nav navbar-nav left Begin -->
                       ...
                       <li class=" dropdown">
						   ...
						   <a href="fast-food.php" class="dropbtn">Fast Food</a>
									<div class="dropdown-content">
									  <a href="burger.php">Burger</a>
									  <a href="chicken_fry.php">Chicken fry</a>
									  <a href="pizza.php">Pizza</a>
									  <a href="sandwish.php">sandwish</a>
									</div>
						</li>
						<li class="">
                           
						   <a href="pure_mustard_oil.php" >Mustard Oil</a>
						</li>
						
						<li class=" dropdown">
                           
						   <a href="meat_and_fish.php" class="dropbtn">Meat and Fish</a>
									<div class="dropdown-content">
