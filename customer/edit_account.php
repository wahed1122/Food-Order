...
$customer_name = get_safe_value($con,$row_customer['customer_name']);

$customer_email = get_safe_value($con,$row_customer['customer_email']);

$customer_country = get_safe_value($con,$row_customer['customer_country']);

$customer_city = get_safe_value($con,$row_customer['customer_city']);

$customer_contact = get_safe_value($con,$row_customer['customer_contact']);

$customer_address = get_safe_value($con,$row_customer['customer_address']);

$customer_image = get_safe_value($con,$row_customer['customer_image']);
...
if(isset($_POST['update'])){
    ...
    $update_id = get_safe_value($con,$customer_id);
    
    $c_name = get_safe_value($con,$_POST['c_name']);
    
    $c_email = get_safe_value($con,$_POST['c_email']);
    
    $c_country = get_safe_value($con,$_POST['c_country']);
    
    $c_city = get_safe_value($con,$_POST['c_city']);
    
    $c_address = get_safe_value($con,$_POST['c_address']);
    
    $c_contact = get_safe_value($con,$_POST['c_contact']);
    
    $c_image = get_safe_value($con,$_FILES['c_image']['name']);
